...
export const WS_ICONS: WsIcons = {
  server: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="2" width="14" height="6" rx="1.5"/>
      <rect x="2" y="10" width="14" height="6" rx="1.5"/>
  ...
  cloud: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4.5 13.5a3.5 3.5 0 01-.35-6.97 5 5 0 019.7 0A3.5 3.5 0 0113.5 13.5h-9z"/>
    </svg>
  ),
  shield: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 2l6 3v4c0 3.5-2.5 6.5-6 7.5-3.5-1-6-4-6-7.5V5l6-3z"/>
    </svg>
  ),
  code: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="5.5 5 2 9 5.5 13"/>
      <polyline points="12.5 5 16 9 12.5 13"/>
  ...
  flask: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 2h4M8 2v5l-4.5 7a1 1 0 00.87 1.5h9.26a1 1 0 00.87-1.5L10 7V2"/>
    </svg>
  ),
  rocket: (
    <svg aria-hidden="true" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 14l-2 2-1-3-3-1 2-2"/>
      <path d="M12.5 2.5c-3 0-6.5 3-7.5 6l5 5c3-1 6-4.5 6-7.5a2.5 2.5 0 00-3.5-3.5z"/>
...
export const SVG: SvgIcons = {
  ...
  del: (
    <svg aria-hidden="true" width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round">
      ...
      <path d="M3 4l1 8a1 1 0 001 1h4a1 1 0 001-1l1-8"/>
    </svg>
  ),
  github: (
