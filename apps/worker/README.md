...
- Access Analyzer raw 위치: `extensions.access_analyzer_findings[].evidence.raw_s3_uri`
- Cost Explorer raw 위치: `extensions.cost_explorer_collection_status.ce.get_cost_and_usage.raw_s3_uri`
- CloudWatch raw 위치: `extensions.cloudwatch_alarms[].evidence.raw_s3_uri`
...
이 finding은 외부 공개 가능 리소스, 교차 계정 접근 등
접근/권한 리스크를 보고서 단계에서 바로 활용할 수 있도록 요약됩니다.

### 8-4. Cost Explorer / CloudWatch
